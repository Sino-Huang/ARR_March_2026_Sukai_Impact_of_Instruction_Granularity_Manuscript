...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    # === Mini Behavior Pure Setting ===
    "mini_behavior_full_instr_pure_L":[
        ("mini_behavior_train_full_instr_id_granularity_L", 1.0),
    ],
    "mini_behavior_full_instr_pure_M":[
        ("mini_behavior_train_full_instr_id_granularity_M", 1.0),
    ],
    "mini_behavior_full_instr_pure_H":[
        ("mini_behavior_train_full_instr_id_granularity_H", 1.0),
    ],
    # === Mini Behavior Mixed Setting ===
    ...
    "mini_behavior_full_instr_axial_L":[
        ("mini_behavior_train_full_instr_id_granularity_L", 1.0),
        ("mini_behavior_train_full_instr_id_granularity_M", 0.15),
        ("mini_behavior_train_full_instr_id_granularity_H", 0.15),
    ],
    "mini_behavior_full_instr_axial_M":[
        ("mini_behavior_train_full_instr_id_granularity_L", 0.15),
        ("mini_behavior_train_full_instr_id_granularity_M", 1.0),
        ("mini_behavior_train_full_instr_id_granularity_H", 0.15),
    ],
    ...
    # === Mini Behavior Pure Setting with single instr ===
    
    "mini_behavior_mix_instr_pure_L":[
        ("mini_behavior_train_full_instr_id_granularity_L", 1.0),
        ("mini_behavior_train_single_instr_id_granularity_L", 0.2),
        
    ],
    "mini_behavior_mix_instr_pure_M":[
        ("mini_behavior_train_full_instr_id_granularity_M", 1.0),
        ("mini_behavior_train_single_instr_id_granularity_M", 0.2),
    ],
    "mini_behavior_mix_instr_pure_H":[
        ("mini_behavior_train_full_instr_id_granularity_H", 1.0),
        ("mini_behavior_train_single_instr_id_granularity_H", 0.2),
    ],
    # === Mini Behavior Mixed Setting with single instr ===
    ...
    "mini_behavior_mix_instr_axial_L":[
        ...
        ("mini_behavior_train_full_instr_id_granularity_M", 0.15),
        ("mini_behavior_train_full_instr_id_granularity_H", 0.15),
        ("mini_behavior_train_single_instr_id_granularity_L", 0.1),
        ("mini_behavior_train_single_instr_id_granularity_M", 0.1),
        ("mini_behavior_train_single_instr_id_granularity_H", 0.1),
    ],
    ...
    # === Mini Behavior Pure Setting Single Instr ===
    "mini_behavior_single_instr_pure_L":[
        ("mini_behavior_train_single_instr_id_granularity_L", 1.0),
    ],
    "mini_behavior_single_instr_pure_M":[
        ("mini_behavior_train_single_instr_id_granularity_M", 1.0),
    ],
    "mini_behavior_single_instr_pure_H":[
        ("mini_behavior_train_single_instr_id_granularity_H", 1.0),
    ],
    # === Mini Behavior Mixed Setting ===
    ...
    "mini_behavior_single_instr_axial_L":[
        ("mini_behavior_train_single_instr_id_granularity_L", 1.0),
        ("mini_behavior_train_single_instr_id_granularity_M", 0.33),
        ("mini_behavior_train_single_instr_id_granularity_H", 0.33),
    ],
    "mini_behavior_single_instr_axial_M":[
        ("mini_behavior_train_single_instr_id_granularity_L", 0.33),
        ("mini_behavior_train_single_instr_id_granularity_M", 1.0),
        ("mini_behavior_train_single_instr_id_granularity_H", 0.33),
    ],
