...
def make_dataset_from_rlds(
    ...
    *,
    ...
    text_based_world_state_key: Optional[str] = None,
    ...
    if text_based_world_state_key is not None:
        REQUIRED_KEYS.add(text_based_world_state_key)
    ...
    def restructure(traj):
        ...
        if text_based_world_state_key is not None:
            if traj[text_based_world_state_key].dtype != tf.string:
                raise ValueError(
                    f"Text-based world state key {text_based_world_state_key} has dtype {traj[text_based_world_state_key].dtype}, "
                    "but it must be tf.string."
                )
            task["text_world_state"] = traj.pop(text_based_world_state_key)
