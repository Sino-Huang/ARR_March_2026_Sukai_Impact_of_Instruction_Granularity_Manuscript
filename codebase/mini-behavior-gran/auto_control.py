...
if __name__ == '__main__':
    ...
    env.unwrapped.save_state('/home/xxxname/Project/granularity_instruction_nsai/granularity-instruction-nsai/data/00_envs/mini_behavior/pddl_gen/state_example.pkl')
