...
class SettingUpCandlesEnv(RoomGrid):
    ...
    def _gen_objs(self):
        ...
        box_pos = self._rand_subset(avail_pos_helper(box[0], self), 3) + self._rand_subset(avail_pos_helper(box[1], self), 3)
...
register(
    id='MiniGrid-SettingUpCandles-12x12-N2-v0',
    entry_point='mini_behavior.envs:SettingUpCandlesEnv',
    kwargs={'room_size': 12}
)

register(
    id='MiniGrid-SettingUpCandles-10x10-N2-v0',
    entry_point='mini_behavior.envs:SettingUpCandlesEnv',
    kwargs={'room_size': 10}
)
