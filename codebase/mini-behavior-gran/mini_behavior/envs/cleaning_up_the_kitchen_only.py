...
class CleaningUpTheKitchenOnlyEnv(RoomGrid):
    ...
    def _gen_objs(self):
        ...
        cabinet_pos = self._rand_subset(avail_pos_helper(cabinets[0], self), 3)  # use the avail_pos_helper to get available positions for cabinets
        ...
        fridge_pos = self._rand_subset(avail_pos_helper(electric_refrigerator, self), 4)
...
register(
    id='MiniGrid-CleaningUpTheKitchenOnly-11x11-N2-v0',
    entry_point='mini_behavior.envs:CleaningUpTheKitchenOnlyEnv',
    kwargs={'room_size': 11}
)

register(
    id='MiniGrid-CleaningUpTheKitchenOnly-13x13-N2-v0',
    entry_point='mini_behavior.envs:CleaningUpTheKitchenOnlyEnv',
    kwargs={'room_size': 13}
)
