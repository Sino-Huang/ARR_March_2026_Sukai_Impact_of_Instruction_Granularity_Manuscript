...
class PuttingAwayDishesAfterCleaningEnv(RoomGrid):
    ...
    def _gen_objs(self):
        ...
        countertop_pos = self._rand_subset(avail_pos_helper(countertop[0], self), 4) + self._rand_subset(avail_pos_helper(countertop[1], self), 4)
...
register(
    id='MiniGrid-PuttingAwayDishesAfterCleaning-8x8-N2-v0',
    entry_point='mini_behavior.envs:PuttingAwayDishesAfterCleaningEnv',
    kwargs={'room_size': 8}
)
...
register(
    id='MiniGrid-PuttingAwayDishesAfterCleaningDense-11x11-N2-v0',
    entry_point='mini_behavior.envs:PuttingAwayDishesAfterCleaningEnv',
    kwargs={'room_size': 11, 'dense_reward': True}
)
