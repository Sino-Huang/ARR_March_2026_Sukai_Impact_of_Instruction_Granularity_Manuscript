...
class WashingPotsAndPansEnv(RoomGrid):
    ...
    def _gen_objs(self):
        ...
        countertop_0_pos = self._rand_subset(avail_pos_helper(countertops[0], self), 3)
        countertop_1_pos = self._rand_subset(avail_pos_helper(countertops[1], self), 3)
...
register(
    id='MiniGrid-WashingPotsAndPansDense-12x12-N2-v0',
    entry_point='mini_behavior.envs:WashingPotsAndPansEnv',
    kwargs={'room_size': 12, 'max_steps': 2000, 'dense_reward': True}
)

register(
    id='MiniGrid-WashingPotsAndPansDense-14x14-N2-v0',
    entry_point='mini_behavior.envs:WashingPotsAndPansEnv',
    kwargs={'room_size': 14, 'max_steps': 3000, 'dense_reward': True}
)
