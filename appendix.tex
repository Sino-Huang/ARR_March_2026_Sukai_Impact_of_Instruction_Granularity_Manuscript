...
We present the width-0 rule set for 10 over 20 household tasks in the Mini-BEHAVIOR-Gran environment. For $w>0$, please refer to the codebase at \url{mini-behavior-gran/mini_behavior/utils/policy_sketch/}. 
