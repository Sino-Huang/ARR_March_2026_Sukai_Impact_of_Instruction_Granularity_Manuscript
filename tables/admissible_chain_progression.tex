...
\toprule
\textbf{State Progression} & \textbf{Concurrent Features Tracked} & \textbf{Width} \\ \midrule
...
Put rag on floor & $[\langle C_1, C_2, H_r \rangle, \ldots, \langle C_1, C_2, O_r \rangle]$ & 3 \\ \bottomrule
\end{tabularx}
